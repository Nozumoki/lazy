...
function s.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	Fusion.AddProcMix(c,true,true,aux.FilterBoolFunctionEx(Card.IsSetCard,0x1908),aux.FilterBoolFunctionEx(Card.IsSetCard,0x1908))
...
function s.filter1(c,e,tp)
	return c:IsFaceup() and c:IsSetCard(0x1908) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
