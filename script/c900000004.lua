...
function s.filter(c)
	return c:IsFaceup() and c:IsSetCard(0x1908) and not c:IsCode(id) and c:HasLevel()
end
...
function s.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsPreviousLocation(LOCATION_HAND+LOCATION_GRAVE+LOCATION_FIELD)
end
	--Activation legality
